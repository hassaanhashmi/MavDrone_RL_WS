#!/usr/bin/env python
import gym
from openai_ros.task_envs.task_envs_list import RegisterOpenAI_Ros_Env
import roslaunch
import rospy
import rospkg
import os
...
class ROSLauncher(object):
    def __init__(self, rospackage_name, launch_file_name, ros_ws_abspath="Please enter correct ros_ws_abspath"):
