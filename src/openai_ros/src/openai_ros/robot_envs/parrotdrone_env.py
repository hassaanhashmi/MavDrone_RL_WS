...
class ParrotDroneEnv(robot_gazebo_env.RobotGazeboEnv):
    """Superclass for all Drone environments.
    """
    ...
    def __init__(self, ros_ws_abspath):
        ...
        * /drone/imu: IMU of the drone giving acceleration and
    ...
    def _imu_callback(self, data):_check_all_publishers_ready
        self.imu = data
    ...
    def move_base(self, linear_speed_vector, angular_speed, epsilon=0.05, update_rate=10):
        ...
        rospy.logdebug("Drone Base Twist Cmd>>" + str(cmd_vel_value))
        self._check_cmd_vel_pub_connection()
