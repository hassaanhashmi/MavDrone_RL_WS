...
from openai_ros.task_envs.hectorquad import hectorquad_goto


if __name__ == '__main__':

    rospy.init_node('hectorquad_goto_qlearn', anonymous=True, log_level=rospy.WARN)

    # Create the Gym environment
    env = gym.make('HectorQuadGoto-v0')
    rospy.loginfo("Gym environment done")

    # Set the logging system
    rospack = rospkg.RosPack()
    pkg_path = rospack.get_path('hectorquad_pkg')
