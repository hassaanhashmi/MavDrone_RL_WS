...
if __name__ == '__main__':
    ...
    rospy.init_node('mavdrone_follow_ddpg',
    ...
    """
    Alpha = rospy.get_param("/mav_drone/alpha")
    Epsilon = rospy.get_param("/mav_drone/epsilon")
    Gamma = rospy.get_param("/mav_drone/gamma")
    epsilon_discount = rospy.get_param("/mav_drone/epsilon_discount")
